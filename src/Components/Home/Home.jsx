...
const Home = () => {
  return (
    <section className="w-full h-[100vh] py-2 bg-slate-200">
      <Nav />
      ...
      <div className="bg-slate-800 h-[8rem] relative bottom-20 flex justify-around px-18 py-9 space-x-[-20rem] text-white text-2xl text-center py-[2.5rem]">
        <div className="">
